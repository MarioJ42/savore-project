...
<header class="page-header">
  <nav>
      ...
      <h2 style="margin-left: 20px;">Savoré Cafe</h2>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="#0" onclick="showOrderList()">
          <svg>
...
<section class="page-content">
  <section class="search-and-user">
    ...
    <div class="admin-profile">
      <span class="greeting">Hello Manager</span>
    ...
    <div class="col" style="padding: 40px;">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo htmlspecialchars($product['id_stok']); ?></td>
                    <td><?php echo htmlspecialchars($product['nama_stok']); ?></td>
                    <td><?php echo htmlspecialchars($product['quantity']); ?></td>
                    <td>
                        <form action="controller.php" method="post">
                            <input type="hidden" name="id_stok" value="<?php echo htmlspecialchars($product['id_stok']); ?>">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <?php foreach ($orders as $order): ?>
                <tr>
                    <td><?php echo htmlspecialchars($order['nama_pegawai']); ?></td>
                    <td><?php echo htmlspecialchars($order['gaji']); ?></td>
                    <td><?php echo htmlspecialchars($order['telp']); ?></td>
                    <td>
                        <form action="controller.php" method="post">
                            <input type="hidden" name="id_pegawai" value="<?php echo htmlspecialchars($order['id_pegawai']); ?>">
                            <input type="number" name="new_gaji" value="<?php echo htmlspecialchars($order['gaji']); ?>" min="0" required>
  ...
  <!-- <section>
      ...
      <div class="modal fade" id="acceptModal" tabindex="-1" aria-labelledby="acceptModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
              ...
              <h5 class="modal-title" id="acceptModalLabel">Accept Request Top Up</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
              Apakah Anda yakin ingin menerima permintaan top up dari customer?
              </div>
      ...
      <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
              <div class="modal-header">
              <h5 class="modal-title" id="rejectModalLabel">Reject Request Top Up</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
              Apakah Anda yakin ingin menolak permintaan top up dari customer?
              </div>
              <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
...
function showOrderList() {
    ...
    document.querySelector('.grid tbody').innerHTML = `
        <?php foreach ($orders as $order): ?>
            <tr>
                <td><?php echo htmlspecialchars($order['nota_pesanan']); ?></td>
                <td><?php echo htmlspecialchars($order['harga_total']); ?></td>
                <td><?php echo htmlspecialchars($order['status']); ?></td>
                <td>
                    <form action="detailpesanan.php" method="get">
                        <input type="hidden" name="nota_pesanan" value="<?php echo htmlspecialchars($order['nota_pesanan']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <form action="controller.php" method="post">
                            <input type="hidden" name="id_stok" value="<?php echo htmlspecialchars($product['id_stok']); ?>">
                            <input type="number" name="quantity" value="0" min="0">
                            <button type="submit" name="action" value="increase">Tambah</button>
                            <button type="submit" name="action" value="decrease">Kurangi</button>
                        </form>
                    </td>
                </tr>
                <?php endforeach; ?>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-primary" onclick="markOrderComplete(12345)">Selesai</button>
                    </td>
                  </tr>
                  <tr>
                    <td>#67890</td>
                    ...
                    <td>
                      <button type="button" class="btn btn-primary" onclick="markOrderComplete(67890)">Selesai</button>
                    </td>
                  </tr>
                </tbody>
              </table>
...
// function acceptTopUp() {
 
//     const acceptModal = document.getElementById('acceptModal');
//     const modal = new bootstrap.Modal(acceptModal);
//     modal.show();
// }

function acceptTopUp() {
// Mengambil modal acceptModal
const acceptModal = document.getElementById('acceptModal');
// Menampilkan modal
...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js" integrity="sha384-ZrALXCRNpI6mBC3zrjFRjlVKj55mCkRlDgbMWb2b9e3JNc6Ejn4SBX4kZu7cHVtN" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js" integrity="sha384-0g8XjcqvVSQv5I2F4HYwkjAyFuZuTwzJg+rC1otKQ2xFW3QAcUzIZz1GGm3x1z6l" crossorigin="anonymous"></script>
</section>